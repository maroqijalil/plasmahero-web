            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-danger text-gradient">Selamat Datang di Plasmahero</h3>
                  <p class="mb-0">Masukkan nama, email, dan password Anda!</p>
                </div>
                <div class="card-body">
                  <form method="POST" action="{{ route('register.store') }}">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control {{ $errors->has('name') ? 'error' : '' }}"
                        placeholder="Nama" aria-label="Nama" name="name" required autofocus>
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control {{ $errors->has('password_confirmation') ? 'error' : '' }}"
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-danger w-100 mt-4 mb-0">Daftar</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    Sudah punya Akun?
                    <a href="{{ route('login') }}" class="text-danger text-gradient font-weight-bold">Masuk</a>
                  </p>
                </div>
              </div>
            </div>
