...
<div class="main-content">
				...
				<div class="header-body text-center">
					<div class="row justify-content-center">
						<div class="col-xl-5 col-lg-6 col-md-8 px-5">
							...
							<h1 class="text-primary">Selamat Datang di Admin Plasmahero!</h1>
							<p class="text-lead text-primary">Masukkan Nama, Email, dan Password untuk mendaftar!</p>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="card bg-secondary border-0 mb-0">
						...
						<form method="POST" action="{{ route('admin.register.store') }}">
							...
							<div class="form-group mb-3">
								<div class="input-group input-group-merge input-group-alternative">
									...
									<input class="form-control {{ $errors->has('name') ? 'error' : '' }}" type="name"
                ...
                <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <span class="input-group-text"><i class="ni ni-lock-circle-open"></i></span>
									...
									<input class="form-control {{ $errors->has('password_confirmation') ? 'error' : '' }}" type="password"
        ...
        <div class="row mt-3">
            ...
            <a href="{{ route('admin.login') }}" class="text-primary-light"><small>Sudah Punya Akun</small></a>
					</div>
        </div>
			</div>
    </div>
